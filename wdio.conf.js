...
const reportPortalToken = process.env.RP_TOKEN;

const conf = {
  reportPortalClientConfig: {
    token: reportPortalToken,
...
const argsForChromeOptions = require('./framework/helpers/option-for-start');
...
exports.config = {
  ...
  services: ['chromedriver', [reportPortalService, {}]],
  ...
  reporters: [[reportPortalReporter, conf]],
  ...
  beforeTest: async function (test, context) {
    logger.info(`${test.title} test has started`)
  },
  /**
  ...
  afterTest: async function (
    ...
    if (!passed) {
      ...
      await reportPortalReporter.sendFile('error', `${screenShotName}.png`, attachment);
    }
  },
